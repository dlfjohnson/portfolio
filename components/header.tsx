...
export default function Header() {
  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        className="fixed top-0 left-1/2 2 h-[4.5rem] border border-white border-opacity-40 shadow-lg shadow-black/[0.03] w-full p-2.5 rounded-none bg-white bg-opacity-80 backdrop-filter backdrop-blur-[20px] backdrop-saturate-[1.7] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75"
